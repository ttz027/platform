$(function () {
    $("#jqGrid").Grid({
        ...
        colModel: [
            ...
            {label: '虚拟点赞数', name: 'initCallNum', index: 'init_call_num', width: 80, formatter: function (value) {
                console.log()
                return "<myspan>"+value+"</myspan>";
            }},
            {label: '点赞数', name: 'callNum', index: 'call_num', width: 80}
            ]
    });
    $('#goodsDesc').editable({
        inlineMode: false,
                    ...
                    if (inputValue) {
                        ...
                        if (!re.test(inputValue)) {
                            ...
                            if (inputValue != count) {
                                Ajax.request({
                                    type: "POST",
                                    url: "../goods/initCallNum",
                                    contentType: "application/json",
                                    params: JSON.stringify({"goodsId":id,"initCallNum":inputValue}),
                                    successCallback: function (r) {
                                        console.log(r);
                                        if(r.code == 0){
                                            alert('操作成功');
